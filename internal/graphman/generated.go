...
var AllAuditFtpSecurityType = []AuditFtpSecurityType{
	AuditFtpSecurityTypeFtpUnsecured,
	AuditFtpSecurityTypeFtpsExplicit,
	AuditFtpSecurityTypeFtpsImplicit,
}
...
var AllCassandraCompression = []CassandraCompression{
	CassandraCompressionNone,
	CassandraCompressionLz4,
}
...
var AllCertRevocationCheckPropertyType = []CertRevocationCheckPropertyType{
	CertRevocationCheckPropertyTypeCrlFromCertificate,
	CertRevocationCheckPropertyTypeCrlFromUrl,
	CertRevocationCheckPropertyTypeOcspFromCertificate,
	CertRevocationCheckPropertyTypeOcspFromUrl,
}
...
var AllCertValidationType = []CertValidationType{
	CertValidationTypeUseDefault,
	CertValidationTypeCertificateOnly,
	CertValidationTypePathValidation,
	CertValidationTypeRevocation,
}
...
var AllCertificateValidationType = []CertificateValidationType{
	CertificateValidationTypeCertificateOnly,
	CertificateValidationTypePathValidation,
	CertificateValidationTypeRevocation,
}
...
var AllEmailServerType = []EmailServerType{
	EmailServerTypeImap,
	EmailServerTypePop3,
}
...
var AllEntityFieldOption = []EntityFieldOption{
	EntityFieldOptionDefault,
	EntityFieldOptionNone,
	EntityFieldOptionCustom,
}
...
var AllEntityMutationAction = []EntityMutationAction{
	EntityMutationActionNewOrUpdate,
	EntityMutationActionNewOrExisting,
	EntityMutationActionAlwaysCreateNew,
	EntityMutationActionIgnore,
	EntityMutationActionDelete,
}
...
var AllEntityMutationStatus = []EntityMutationStatus{
	EntityMutationStatusNone,
	EntityMutationStatusCreated,
	EntityMutationStatusUpdated,
	EntityMutationStatusDeleted,
	EntityMutationStatusUsedExisting,
	EntityMutationStatusIgnored,
	EntityMutationStatusError,
}
...
var AllKeyUsageType = []KeyUsageType{
	KeyUsageTypeSsl,
	KeyUsageTypeCa,
	KeyUsageTypeAuditViewer,
	KeyUsageTypeAuditSigning,
}
...
var AllL7PolicyType = []L7PolicyType{
	L7PolicyTypeFragment,
	L7PolicyTypePreRoutingFragment,
	L7PolicyTypeSuccessfulRoutingFragment,
	L7PolicyTypeFailedRoutingFragment,
	L7PolicyTypeAuthenticationSuccessFragment,
	L7PolicyTypeAuthenticationFailureFragment,
	L7PolicyTypeAuthorizationSuccessFragment,
	L7PolicyTypeAuthorizationFailureFragment,
	L7PolicyTypeGlobal,
	L7PolicyTypeInternal,
	L7PolicyTypePolicyBackedIdp,
	L7PolicyTypePolicyBackedOperation,
	L7PolicyTypePolicyBackedBackgroundTask,
	L7PolicyTypePolicyBackedServiceMetrics,
}
...
var AllL7ServiceType = []L7ServiceType{
	L7ServiceTypeWebApi,
	L7ServiceTypeSoap,
	L7ServiceTypeInternalWebApi,
	L7ServiceTypeInternalSoap,
}
...
var AllListenPortClientAuth = []ListenPortClientAuth{
	ListenPortClientAuthNone,
	ListenPortClientAuthOptional,
	ListenPortClientAuthRequired,
}
...
var AllListenPortFeature = []ListenPortFeature{
	ListenPortFeaturePublishedServiceMessageInput,
	ListenPortFeaturePolicyManagerAccess,
	ListenPortFeatureEnterpriseManagerAccess,
	ListenPortFeatureAdministrativeAccess,
	ListenPortFeatureBrowserBasedAdministration,
	ListenPortFeaturePolicyDownloadService,
	ListenPortFeaturePingService,
	ListenPortFeatureWsTrustSecurityTokenService,
	ListenPortFeatureCertificateSigningService,
	ListenPortFeaturePasswordChangingService,
	ListenPortFeatureWsdlDownloadService,
	ListenPortFeatureSnmpQueryService,
	ListenPortFeatureBuiltInServices,
	ListenPortFeatureNodeControl,
	ListenPortFeatureInterNodeCommunication,
}
...
var AllLogSeverityThreshold = []LogSeverityThreshold{
	LogSeverityThresholdAll,
	LogSeverityThresholdFinest,
	LogSeverityThresholdFiner,
	LogSeverityThresholdFine,
	LogSeverityThresholdConfig,
	LogSeverityThresholdInfo,
	LogSeverityThresholdWarning,
	LogSeverityThresholdSevere,
}
...
var AllLogSinkCategory = []LogSinkCategory{
	LogSinkCategoryLog,
	LogSinkCategoryTraffic,
	LogSinkCategoryAudit,
	LogSinkCategorySspc,
}
...
var AllLogSinkType = []LogSinkType{
	LogSinkTypeFile,
	LogSinkTypeSyslog,
}
...
var AllModuleType = []ModuleType{
	ModuleTypeModularAssertion,
	ModuleTypeCustomAssertion,
}
...
var AllOcspNonceUsage = []OcspNonceUsage{
	OcspNonceUsageIncludeNonce,
	OcspNonceUsageExcludeNonce,
	OcspNonceUsageUseNonceConditionally,
}
...
var AllPolicyUsageType = []PolicyUsageType{
	PolicyUsageTypeNone,
	PolicyUsageTypeUseDefault,
	PolicyUsageTypeSpecified,
}
...
var AllSMCryptoMode = []SMCryptoMode{
	SMCryptoModeCompat,
	SMCryptoModeMigrate,
	SMCryptoModeFips,
}
...
var AllSoapVersion = []SoapVersion{
	SoapVersionSoap11,
	SoapVersionSoap12,
	SoapVersionUnknown,
}
...
var AllTrustedForType = []TrustedForType{
	TrustedForTypeSsl,
	TrustedForTypeSigningServerCerts,
	TrustedForTypeSigningClientCerts,
	TrustedForTypeSamlIssuer,
	TrustedForTypeSamlAttestingEntity,
}
...
// The mutation executed by deleteKeys.
...
func deleteKeys(
	...
	keys []string,
) (data_ *deleteKeysResponse, err_ error) {
...
// The mutation executed by deleteL7PortalApi.
...
func deleteL7PortalApi(
	...
	secretNames []string,
) (data_ *deleteL7PortalApiResponse, err_ error) {
	req_ := &graphql.Request{
	...
	data_ = &deleteL7PortalApiResponse{}
	resp_ := &graphql.Response{Data: data_}
...
// The mutation executed by installBundle.
...
) (data_ *installBundleResponse, err_ error) {
	req_ := &graphql.Request{
...
// The mutation executed by installBundleGeneric.
...
func installBundleGeneric(
	ctx_ context.Context,
	client_ graphql.Client,
) (data_ *installBundleGenericResponse, err_ error) {
	req_ := &graphql.Request{
		OpName: "installBundleGeneric",
		Query:  installBundleGeneric_Operation,
	}

	data_ = &installBundleGenericResponse{}
	resp_ := &graphql.Response{Data: data_}
